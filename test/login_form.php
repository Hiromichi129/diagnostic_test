...
<body>
    <div class="header">
        ...
        <div class="header-list">
         ...
         onMouseOver="this.style.color='#C0C0C0'" onmouseout="this.style.color='#000000'">ログイン</li>
    ...
    <div class="main-c">
        ...
        <br><a href="signup_form.php" style="cursor: pointer;"
         onMouseOver="this.style.color='#C0C0C0'" onmouseout="this.style.color='#000000'">新規登録はこちら</a></br>
    </div>
</body>
